...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::VsCodeLogo => "bundled/svg/vscode.svg",
            Icon::WindsurfLogo => "bundled/svg/windsurf.svg",
            Icon::ZedLogo => "bundled/svg/zed.svg",
            Icon::AntigravityIdeLogo => "bundled/svg/antigravity.svg",
